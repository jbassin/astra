...
export function handleAddClick(ctx: HexClickContext, q: number, r: number): void {
  ...
  if (factionIdxForSelection !== null && clickedFactionIdx !== factionIdxForSelection) {
...
export function handleRemoveClick(ctx: HexClickContext, q: number, r: number): void {
...
export function handleUpdateClick(ctx: HexClickContext, q: number, r: number): void {
  const { state, factions, regions, hexFaction, hexRegion, pickedRegion, dispatch } = ctx;
  dispatch({ type: "setError", error: null });
...
export function handleSkeinAddClick(ctx: HexClickContext, q: number, r: number): void {
...
export function handleSkeinConnectClick(ctx: HexClickContext, q: number, r: number): void {
...
export function handleClaimClick(ctx: HexClickContext, q: number, r: number): void {
  const { dispatch } = ctx;
  dispatch({ type: "setError", error: null });
  dispatch({ type: "toggleHex", q, r });
}

/**
 * Deterministic "imperfection" seed. Grime — slight stamp rotation and a
 ...
 * Lifted verbatim from faerrin (keeps future visual goldens stable — L3).
 */
...
export interface Grime {
  /** Stamp rotation in degrees, within ±2°. */
  rotateDeg: number;

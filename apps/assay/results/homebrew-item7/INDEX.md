...
| fault-line (+hypercompression, raise-island) | **Divine restored family-wide + range 500→120 (A-extended)** — divine added to ALL THREE terrain-scale kosmoturgy holdouts (5e Cleric/Paladin lineage; 28/28 school spells now carry divine); Fault Line range 500→120 ft (stakeholder trim); prone-on-failure + 8d10 kept (his flagged, compensated trade); verdict −0.63→+1.12 HOT = the DOCUMENTED range-bucket lens artifact (blunt >1-rank lever, dice untouched, spell strictly weaker at table) | see commit |
